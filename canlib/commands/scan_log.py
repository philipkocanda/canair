"""
``canair scan-log`` — Parse ECU scan log files to extract RoutineControl (0x31) results.

Log format:
  [timestamp] <request> -> [echo] | [request_echo] | <response>

Usage:
  canair scan-log logs/ecu/BCM-2026-04-20.log
  canair scan-log logs/ecu/BCM-2026-04-20.log --service 31
  canair scan-log logs/ecu/BCM-2026-04-20.log --hits-only
"""
...
def add_parser(subparsers):
    parser = subparsers.add_parser(
        NAME,
        help="Parse ECU scan log files to extract RoutineControl (0x31) results",
        description="Parse ECU scan log files.",
    )
